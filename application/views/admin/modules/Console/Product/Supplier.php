<script  type="text/javascript">
    TABLE_SUP_PRODUCT = '<?=TABLE_SUPPLIER_PRODUCTS?>';
</script>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            foreach ($data['data'] as $key=>$value)
                            {
                                ...
                                <tr id="tr<?=$value['i_id']?>">
                                    ...
                                    <td><?=$value['v_price']?></td>
                                    <td>
                                        <select id="tg<?=$value['i_id']?>" onchange="change_sup_product_status(<?=$value['i_id']?>,'<?=($value['e_status']=="Active") ? 'Inactive': 'Active' ?>')">
                                    ...
                                    <td>
                                        <button class="btn btn-danger btn-xs" onclick="delete_sup_product(<?=$value['i_id']?>);"><i class="fa fa-trash fa-lg"></i></button>
                                    </td>
                                </tr>
                                <?php
                            }
